  ...
  return (
    <header className="flex items-center justify-between pb-6 border-b">
      ...
      <div className="flex items-center border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-gray-300">
        ...
        <div>Any Week</div>
        <div className="border-l border-gray-300 px-2">Add Guests</div>
      ...
      <div className="flex items-center border border-gray-300 rounded-full py-1 px-2 gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        <Link
          ...
          className="bg-gray-500 rounded-full text-white p-1 overflow-hidden"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
const Logo = () => {
  return (
    <Link to="/" className="flex items-center gap-1">
      ...
      <span className="font-bold text-xl"> Air Bnc</span>
    </Link>
  );
};
