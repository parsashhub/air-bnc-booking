...
export default function PhotosUploader({ values, setFieldValue }) {
  const [photoLink, setPhotoLink] = useState("");

  async function addPhotoByLink(ev) {
    ev.preventDefault();
    try {
      const { data: name } = await axios.post("/api/upload/byLink", {
        link: photoLink,
      });
      // values.photos.push(name.data);
      setFieldValue("photos", [...values, name.data]);
      setPhotoLink("");
      toast.success("photo link uploaded successfully");
    } catch (e) {
  ...
  function uploadPhoto(ev) {
    ...
    axios
      ...
      .then((response) => {
        ...
        names.forEach((item) => setFieldValue("photos", [...values, item]));
